        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="well">
                ...
                <div class="alert alert-danger alert-dismissable alert-link">
                    ...
                    Debe tener el formato 999999999<br>
                ...
                <form:form action="usuario/registro.do" modelAttribute="usuarioForm" acceptCharset="UTF-8">
                    ...
                    <div
                        class="form-group ${errores.contains('username') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('password') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('confirmarPassword') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('nombre') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('apellidos') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('email') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('DNI') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('provincia') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('cp') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('telefono') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                    ...
                    <div
                        class="form-group ${errores.contains('checkTerminos') ? 'has-error has-feedback' : 'has-success has-feedback'}">
                        <div class="checkbox">
