    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="well">
                ...
                <form:form action="admin/modificarPerfil.do" modelAttribute="usuarioForm" acceptCharset="UTF-8">
                    ...
                    <div class="form-group text-center">
                        <br>
                        <a href="/admin/perfil.do" class="btn btn-primary"><i class="fa fa-arrow-left"></i>
                            <spring:message
                            code="volver"/></a>
