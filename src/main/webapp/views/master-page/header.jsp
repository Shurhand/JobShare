...
<div class="container">
    <div class="navbar-header">
        ...
        <a href="${base}"><img src="images/JobShareletras.png" width="90px"></a>
...
<ul class="nav navbar-nav">
    ...
    <security:authorize access="hasAuthority('CUSTOMER')">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
               aria-expanded="false"><spring:message code="master.page.activities"/><span class="caret"></span></a>
    ...
    <security:authorize access="hasAuthority('CUSTOMER')">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
               aria-expanded="false"><spring:message code="master.page.routes"/><span class="caret"></span></a>
            <ul class="dropdown-menu">
                ...
                <li><a href="route/customer/listCustom.do"><spring:message code="master.page.custom.route.list"/></a>
                </li>
    ...
    <security:authorize access="hasAuthority('ADMIN')">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
               aria-expanded="false"><spring:message code="master.page.companies"/><span class="caret"></span></a>
            <ul class="dropdown-menu">
    ...
    <security:authorize access="hasAuthority('ADMIN')">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
               aria-expanded="false"><spring:message code="master.page.category"/><span class="caret"></span></a>
            <ul class="dropdown-menu">
...
<security:authorize access="isAnonymous()">
    <div id="navbar" class="navbar-collapse collapse">
        <form:form class="navbar-form navbar-right" action="login" modelAttribute="credenciales">
...
<security:authorize access="isAuthenticated()">
    ...
    <form:form class="navbar-form navbar-right">
        <div class="form-group">
            <p class="navbar-text navbar-right2"><spring:message code="master.page.salute"/>&nbsp&nbsp
